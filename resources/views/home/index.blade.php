            ...
            <ul class="p-0 m-0">
              <li class="mb-3 pb-1 d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{ asset('') }}assets/img/icons/brands/laravel-logo.png"
                    alt="laravel-logo"
                    class="me-3"
                    width="35"
                  />
              ...
              <li class="mb-3 pb-1 d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{ asset('') }}assets/img/icons/brands/figma-logo.png"
                    alt="figma-logo"
                    class="me-3"
                    width="35"
                  />
              ...
              <li class="mb-3 pb-1 d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{ asset('assets/img/icons/brands/vue-logo.png') }}"
                    alt="vue-logo"
                    class="me-3"
                    width="35"
                  />
              ...
              <li class="mb-3 pb-1 d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{ asset('assets/img/icons/brands/react-logo.png') }}"
                    alt="react-logo"
                    class="me-3"
                    width="35"
                  />
              ...
              <li class="mb-3 pb-1 d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{ asset('assets/img/icons/brands/bootstrap-logo.png') }}"
                    alt="bootstrap-logo"
                    class="me-3"
                    width="35"
                  />
              ...
              <li class="d-flex">
                <div class="d-flex w-50 align-items-center me-3">
                  <img
                    src="{{ asset('assets/img/icons/brands/sketch-logo.png') }}"
                    alt="sketch-logo"
                    class="me-3"
                    width="35"
                  />
                ...
                <tr>
                  <td>
                    <div class="d-flex justify-content-start align-items-center">
                      <div class="me-3">
                        <img
                          src="{{ asset('assets/img/icons/payments/master-card-img.png') }}"
                          alt="Visa"
                          height="30"
                        />
                      </div>
                ...
                <div class="timeline-event">
                  ...
                  <div class="d-flex flex-wrap gap-2 pt-1">
                    ...
                    <a href="javascript:void(0)">
                      <img
                        src="{{ asset('assets/img/icons/misc/xls.png') }}"
                        alt="Excel image"
                        width="15"
                        class="me-2"
                      />
